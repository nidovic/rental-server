...
@AllArgsConstructor
@Data
@Table(name = "contract_payment_debt")
public class ContractPaymentDebtEntity {
    @JsonProperty("contractPaymentDebtId")
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    private UUID contractPaymentDebtId;

    @JsonProperty("amountInXAF")
    private double amountInXAF;

    @JsonProperty("status")
    private String status; // Cancelled, outToDate, Active
